...
export const BlindFighting: EdgeDetail = {
  ...
  description:
    "Whether your cowpoke's blind as a bat, or just well-versed in night-fighting, he's got the advantage in darkness. The character receives no penalties for darkness when attacking foes withing 3 tiles, and can sense their movement well enough to move toward them as if he could see them. Characters with the Blind Hindrance suffer no penalties when making Fighting rolls against opponents within 3 tiles",
  description_short:
    "Character suffer no penalty from darkness or blindness when attacking within 3 tiles",
