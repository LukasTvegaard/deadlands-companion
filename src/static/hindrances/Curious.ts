...
export const Curious: HindranceDetailType = {
  key: Hindrance.Curious,
  name: "Curious",
  description:
  ...
  description_short:
    "Always has to investigate everything. Wants to learn what's behind every potential mystery.",
  effects: [],
};
